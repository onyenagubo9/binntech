    ...
    >
      ...
      <div className="relative z-20 backdrop-blur-xl bg-white/10 border border-white/20 p-10 rounded-2xl shadow-xl max-w-md w-full animate-card-in">
        ...
        <h1 className="text-3xl font-bold text-center mb-2 animate-fade-slow">
          Create Your <span className="text-blue-400">BinnTech</span> Account
        </h1>

        <p className="text-center text-gray-300 mb-8 animate-fade-slow">
          Access premium AI developer tools instantly
        </p>
        ...
        <p className="text-center mt-6 text-gray-300">
          ...
          <a href="/auth/login" className="text-blue-400 ml-1 hover:underline">
            Login
          </a>
        </p>
      </div>
...
/* Animations + Glow */
.animate-card-in {
  animation: cardIn 0.9s ease-out forwards, cardGlow 3s ease-in-out infinite;
  opacity: 0;
...
@keyframes logoGlow { 0% {filter:drop-shadow(0 0 6px #60a5fa);} 100% {filter:drop-shadow(0 0 14px #3b82f6);} }
